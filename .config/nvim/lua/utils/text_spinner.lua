...
function VirtualTextSpinner.new(opts)
	local merged_spinner_opts = vim.tbl_deep_extend("force", spinner_opts, opts.opts or {})
	local width = opts.width or 0
	local width_center = width - merged_spinner_opts.spinner_text:len()
	...
	return setmetatable({
		...
		opts = vim.tbl_deep_extend("force", merged_spinner_opts, { extmark = { virt_text_win_col = col } }),
